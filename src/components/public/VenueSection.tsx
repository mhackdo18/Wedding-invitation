...
export default function VenueSection({ typo, heroImageUrl, animEnabled }: { typo?: Record<string, TypeStyle>; heroImageUrl?: string; animEnabled?: boolean }) {
  ...
  return (
    <section className="px-6 py-8" style={{ borderTop: '1px solid rgba(120,90,60,0.15)' }}>
      ...
      <HeroImage url={heroImageUrl || ''} alt="Venues" />

      <div className="max-w-md mx-auto space-y-4">
        {venues.map((v, idx) => (
          <Reveal key={v.id} enabled={!!animEnabled} animation={idx % 2 === 0 ? 'fade-left' : 'fade-right'} delay={idx * 80}>
