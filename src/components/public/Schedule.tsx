...
export default function Schedule({
  events, typo, partner1, partner2,
}: { events: WeddingEvent[]; typo: Record<string, TypeStyle>; partner1?: string; partner2?: string }) {
                        ...
                        <div className="mt-2 rounded-lg overflow-hidden" style={{ background: 'rgba(138,109,59,0.06)', border: '1px solid rgba(138,109,59,0.12)' }}>
                          ...
                          <div className="px-3 py-2 flex items-center gap-1.5">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {ev.venue.address && <span className="text-xs" style={{ color: '#8a7a66', ...typeStyle(typo.venueLocation) }}> · {ev.venue.address}</span>}
                            </div>
                          </div>
                        </div>
                      )}
