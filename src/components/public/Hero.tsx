  ...
  return (
    <header className="text-center px-6 pt-12 pb-8 relative overflow-hidden">
      ...
      <div className="relative">
        <p style={{ ...typeStyle(typo.heroPretitle), fontSize: 12, letterSpacing: '0.3em', textTransform: 'uppercase', color: '#a07c4a' }}>
        ...
        {dateStr && (
          <p style={{ ...typeStyle(typo.heroDate), fontSize: 15, color: '#6b5d4f', marginTop: 8 }}>
            {dateStr}
          </p>
        )}
        {settings.venue_line && (
          <p style={{ ...typeStyle(typo.heroVenue), fontSize: 13, color: '#8a7a66', marginTop: 2 }}>
            {settings.venue_line}
          </p>
        )}
      </div>
