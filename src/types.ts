export interface SiteSettings {
  ...
  rsvp_thank_you_message: string | null;
  rsvp_thank_you_title: string | null;
  rsvp_thank_you_font: string | null;
  rsvp_thank_you_font_size: number | null;
  rsvp_thank_you_text_color: string | null;
  rsvp_thank_you_hero_image_url: string | null;
  rsvp_hero_image_url: string | null;
  door_style: string;
  door_color: string | null;
  door_show_names: boolean;
  door_name_font: string;
  door_name_color: string | null;
  door_show_date: boolean;
  door_date_font: string;
  door_date_color: string | null;
  door_show_monogram: boolean;
  door_monogram_color: string | null;
  door_animation_speed: string;
  door_name_size: number;
  door_date_size: number;
  door_monogram_size: number;
...
export interface InformationBlock {
  ...
  columns?: 1 | 2;
  subheading2?: string;
  subheading2_font_family?: string;
  subheading2_font_color?: string;
  subheading2_font_size?: number;
  body2_html?: string;
  photo2_url?: string | null;
  body2_font_family?: string;
  body2_font_color?: string;
  body2_font_size?: number;
}
